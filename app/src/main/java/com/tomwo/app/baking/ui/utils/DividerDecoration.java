...
package com.tomwo.app.baking.ui.utils;
...
{
    private static final int[] ATTRS = new int[]{android.R.attr.dividerHeight, android.R.attr.divider};
    ...
    public DividerDecoration(@NonNull Context context)
    {
        ...
        float dividerHeight = a.getDimension(0, 1f);
        mDividerPaint.setStrokeWidth(dividerHeight);
        mHalfHeight = dividerHeight / 2f;
